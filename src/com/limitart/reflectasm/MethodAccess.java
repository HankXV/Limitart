		...
		try {
			...
			synchronized (loader) {
				try {
					...
					MethodVisitor mv;
					cw.visit(V1_1, ACC_PUBLIC + ACC_SUPER, accessClassNameInternal, null, "com/limitart/reflectasm/MethodAccess",
						null);
					{
						mv = cw.visitMethod(ACC_PUBLIC, "<init>", "()V", null, null);
						mv.visitCode();
						mv.visitVarInsn(ALOAD, 0);
						mv.visitMethodInsn(INVOKESPECIAL, "com/limitart/reflectasm/MethodAccess", "<init>", "()V");
						mv.visitInsn(RETURN);
						mv.visitMaxs(0, 0);
						mv.visitEnd();
					}
