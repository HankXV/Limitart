...
public abstract class FieldAccess {
	...
	public static FieldAccess get(Class type) {
		return get(type, true, new FieldFilter() {
	...
	@SuppressWarnings("rawtypes")
	public static FieldAccess get(Class type, boolean isSuper, FieldFilter filter) {
		...
		try {
			...
			synchronized (loader) {
				try {
					...
					cw.visit(196653, 33, accessClassNameInternal, null, "com/limitart/reflectasm/FieldAccess", null);
	...
	static private void insertConstructor(ClassWriter cw) {
		...
		mv.visitMethodInsn(INVOKESPECIAL, "com/limitart/reflectasm/FieldAccess", "<init>", "()V");
		mv.visitInsn(RETURN);
		mv.visitMaxs(1, 1);
		mv.visitEnd();
	}
