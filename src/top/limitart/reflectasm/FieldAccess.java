package top.limitart.reflectasm;
...
public abstract class FieldAccess {
    ...
    public static FieldAccess get(Class type) {
        return get(type, true, field -> !(ReflectionUtil.isStatic(field)) && !(ReflectionUtil.isPrivate(field)));
    }

    @SuppressWarnings("rawtypes")
    public static FieldAccess get(Class type, boolean isSuper, Test1<Field> filter) {
        ...
        try {
            ...
            synchronized (loader) {
                try {
                    ...
                    cw.visit(196653, 33, accessClassNameInternal, null, ReflectASMConst.PACKAGE_NAME + "FieldAccess",
                            null);
