...
public abstract class ConstructorAccess<T> {
	 ...
	 * <p>
	 * If the underlying class is a inner (non-static nested) class, a new instance
	 * will be created using <code>null</code> as the this$0 synthetic reference.
	 * The instantiated object will work as long as it actually don't use any member
	 * variable or method fron the enclosing instance.
	 */
	 ...
	 *            The instance of the enclosing type to which this inner instance is
			...
			synchronized (loader) {
				try {
					...
					String superclassNameInternal = Modifier.isPublic(modifiers)
							...
							: ReflectASMConst.PACKAGE_NAME + "ConstructorAccess";
