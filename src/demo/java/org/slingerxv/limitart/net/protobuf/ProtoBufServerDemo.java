...
public class ProtoBufServerDemo {
	public static void main(String[] args) throws Exception {
		...
		factory.registerHandler(new HelloToServerHandler());
		ProtoBufServer server = new ProtoBufServerBuilder().addressPair(new AddressPair(8888)).factory(factory).build();
		server.startServer();
	}
}
